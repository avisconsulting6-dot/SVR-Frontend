 ...
 * Tapping opens a WhatsApp chat (app on mobile, web on desktop) with a
 * pre-filled message. Numbers must be in international format WITHOUT
 * the leading + or spaces, e.g. 919876543210.
 */
const WHATSAPP_NUMBER = '6304360779'   // TODO: replace with SVR's real number
const PREFILL = 'Hello SVR Educational Society, I have a question.'
